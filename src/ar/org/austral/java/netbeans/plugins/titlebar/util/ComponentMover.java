 ...
 *
 * This file is base on the ComponentMover.java file by Rob Camick 
 * on September 13, 2009, the original file's license type is unknown.
 * See <https://tips4java.wordpress.com/2009/06/14/moving-windows/>
 ...
 * 
 *  this class is based on the ComponentMover.java file by Rob Camick 
 *  on September 13, 2009, the original file's license type is unknown. 
 * 
 *  @author Rob Camick
 *  @author astral
 *  @see https://tips4java.wordpress.com/2009/09/13/resizing-components
 *  @see http://www.camick.com/java/source/ComponentMover.java
 */
public class ComponentMover extends MouseAdapter
{
	 ...
	 *
         * @param components
	 */
	public final void registerComponent(Component... components)
	{
		for (Component component : components)
