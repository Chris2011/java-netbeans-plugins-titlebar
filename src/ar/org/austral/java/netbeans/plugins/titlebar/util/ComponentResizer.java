 ...
 *
 * This file is base on the ComponentResizer.java file by Rob Camick 
 * on September 13, 2009, the original file's license type is unknown.
 ...
 * of the component.
 * 
 * this class is based on the ComponentResizer.java file by Rob Camick 
 * on September 13, 2009, the original file's license type is unknown. 
 * 
 * @author Rob Camick
 * @author astral
...
public class ComponentResizer extends MouseAdapter
{
    ...
    /**
     * constant declaration of the north, top border.
     */
    protected static final int NORTH = 1;
    /**
     * constant declaration of the west, left border.
     */
    protected static final int WEST = 2;
    /**
     * constant declaration of the south, bottom border.
     */
    protected static final int SOUTH = 4;
    /**
     * constant declaration of the east, right border.
     */
    ...
    /**
     * hold a reference for the destination component to resize.
     */
     ...
     *  a single pixel. Components must be registered separately.
     *  
     *  @param destinationComponent the component resize events should be forwareded to
     * 
     */
    public ComponentResizer(Component destinationComponent)
    {
        this(destinationComponent, new Insets(5, 5, 5, 5), new Dimension(1, 1));
    }
    ...
    {
        this((Component) null, components);
    }
     ...
     *  @param components components to be automatically registered
     */
    public ComponentResizer(Component destinationComponent, Component... components)
    {
        this(destinationComponent, new Insets(5, 5, 5, 5), new Dimension(1, 1), components);
    }
    ...
    {
        this(null, dragInsets, components);
    }
     ...
     *  @param components components to be automatically registered
     */
    public ComponentResizer(Component destinationComponent, Insets dragInsets, Component... components)
    {
        this(destinationComponent, dragInsets, new Dimension(1, 1), components);
    }
    ...
    {
        this(null, dragInsets, snapSize, components);
    }
     ...
     *  @param components components to be automatically registered
     */
    public ComponentResizer(Component destinationComponent, Insets dragInsets, Dimension snapSize, Component... components)
    {
    ...
    /**
     *  Get the components validated minimum size.
     ...
     *  @return the minimum size
     *  @see #getValidatedMinimumWidth() 
     *  @see #getValidatedMinimumHeight()
     */
    public Dimension getValidatedMinimumSize()
    {
        return new Dimension(getValidatedMinimumWidth(), getValidatedMinimumHeight());
    }
    ...
    public void mouseMoved(MouseEvent e)
    {
        ...
        //SwingUtilities.convertPoint(source, location, target);
    ...
    public void mousePressed(MouseEvent e)
    {
        ...
        Component target;
        if (null == destinationComponent)
            target = source;
        else
            target = destinationComponent;                
    ...
    public void mouseReleased(MouseEvent e)
    {
        ...
        if (target instanceof JComponent)
        {
            ((JComponent)target).setAutoscrolls( autoscrolls );
        }
    }
    ...
    public void mouseDragged(MouseEvent e)
    {
        ...
        changeBounds(target, direction, bounds, pressed, dragged);
    }
    
    /**
     * change the source component bounds.
     * @param source
     * @param direction
     * @param bounds
     * @param pressed
    ...
    protected void changeBounds(Component source, int direction, Rectangle bounds, Point pressed, Point current)
    {
        ...
        if (WEST == (direction & WEST))
        {
            ...
            drag = getDragBounded(drag, snapSize.width, width, getValidatedMinimumWidth(), maximum);
        ...
        if (NORTH == (direction & NORTH))
        {
            ...
            drag = getDragBounded(drag, snapSize.height, height, getValidatedMinimumHeight(), maximum);
    ...
    /**
     *  util funcition to computes the minimun width.
     *  When the components minimum size is less than the drag insets then
     *  we can't determine which border should be resized so we need to
     *  prevent this from happening.
     *  @return 
     *  @see #getValidatedMinimumSize()
     */
    public int getValidatedMinimumWidth(){
        if (null == dragInsets)
            return minimumSize.height;
        int dragInsetsWidth = dragInsets.right - dragInsets.left;
        if(minimumSize.width < dragInsetsWidth)
            return dragInsetsWidth;
        else 
            return minimumSize.width;
    }

    /**
     *  util funcition to computes the minimun height:
     *  When the components minimum size is less than the drag insets then
     *  we can't determine which border should be resized so we need to
     *  prevent this from happening.
     *  @return 
     *  @see #getValidatedMinimumSize()
     */
    public int getValidatedMinimumHeight(){
        if (null == dragInsets)
            return minimumSize.width;
        int dragInsetsHeight = dragInsets.bottom - dragInsets.top;
        if(minimumSize.height < dragInsetsHeight)
            return dragInsetsHeight;
        else 
            return minimumSize.height;
    }
}
